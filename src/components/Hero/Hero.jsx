const Hero = () => {
  return (
    <div className="relative z-10 flex grow items-center justify-center pt-20 lg:pt-30 px-5 lg:px-0">
      <div
      ...
      >
        ...
        {/* Description Text */}
        <p className="mx-auto max-w-3xl text-[15px] md:text-[20px] font-medium leading-relaxed text-blue-100">
